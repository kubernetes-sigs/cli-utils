...
func (i *DeleteOrUpdateInvTask) updateInventory(taskContext *taskrunner.TaskContext) error {
	...
	prevInventory := i.ClusterInventory.Objects()
	...
	if err := i.InvClient.CreateOrUpdate(taskContext.Context(), i.ClusterInventory, inventory.UpdateOptions{}); err != nil {
		return err
	}

	if i.StatusPolicy == inventory.StatusPolicyAll {
...
func (i *DeleteOrUpdateInvTask) deleteInventory(ctx context.Context) error {
	...
	err := i.InvClient.Delete(ctx, i.InvInfo, inventory.DeleteOptions{})
