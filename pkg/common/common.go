...
const (
	...
	// prevent mutating a resource.
	IgnoreMutation = "ignore"

	// IgnoreMutationPatchAnnotation is the annotation key for the mutation patch.
	IgnoreMutationPatchAnnotation = "client.lifecycle.config.k8s.io/mutation-patch"
)
