...
func (fc *FakeClient) Load(_ context.Context, invInfo InventoryInfo) (*actuation.Inventory, error) {
	if fc.Err != nil {
		return nil, fc.Err
	}
...
func (fc *FakeClient) Delete(_ context.Context, _ InventoryInfo, _ common.DryRunStrategy) error {
	if fc.Err != nil {
		return fc.Err
	}
	return nil
