...
// InventoryInfoFromObject builds an InventoryInfo from an inventory object
// (structured or unstrutured).
func InventoryInfoFromObject(obj client.Object) InventoryInfo {
	return InventoryInfo{
		ObjectReference: ObjectReferenceFromObject(obj),
		ID:              InventoryLabel(obj),
	}
}
...
func NewInfoStringer(info InventoryInfo) InfoStringer {
	return InfoStringer{
		Info: info,
	}
}
