...
type Inventory interface {
	Info() Info
	// ObjectRefs returns the list of object references tracked in the inventory
	ObjectRefs() object.ObjMetadataSet
	// ObjectStatuses returns the list of statuses for each object reference tracked in the inventory
...
type UpdateOptions struct {
	// SkipStatusUpdate indicates that the status update step should be skipped
...
// ObjectRefs returns the list of object references tracked in the inventory
func (inv *InventoryContents) ObjectRefs() object.ObjMetadataSet {
	return inv.Objs
}

// ObjectStatuses returns the list of statuses for each object reference tracked in the inventory
func (inv *InventoryContents) ObjectStatuses() []actuation.ObjectStatus {
...
func (cic *UnstructuredClient) CreateOrUpdate(ctx context.Context, inv Inventory, opts UpdateOptions) error {
	...
	if cic.statusPolicy != StatusPolicyAll || opts.SkipStatusUpdate {
		return nil
	}
	attempt = 0
