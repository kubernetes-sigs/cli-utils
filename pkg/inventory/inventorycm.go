...
func buildDataMap(objMetas object.ObjMetadataSet, objStatus actuation.ObjectStatusSet, statusEnabled bool) (map[string]string, error) {
...
func parseDataMap(objMap map[string]string, statusEnabled bool) (object.ObjMetadataSet, actuation.ObjectStatusSet, error) {
	var objRefList object.ObjMetadataSet
	var objStatusList actuation.ObjectStatusSet
