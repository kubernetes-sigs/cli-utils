...
func TestGet(t *testing.T) {
	...
	tests := map[string]struct {
		...
		objStatus     actuation.ObjectStatusSet
		isError       bool
	}{
...
func TestCreateOrUpdate(t *testing.T) {
	tests := map[string]struct {
		...
		createObjectStatuses actuation.ObjectStatusSet
		updateObjectRefs     object.ObjMetadataSet
		updateObjectStatuses actuation.ObjectStatusSet
		isError              bool
	}{
...
func TestDelete(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"Local inventory with a single object": {
			...
			objStatus: actuation.ObjectStatusSet{podStatus(t, pod2Info)},
		},
		"Local inventory with multiple objects": {
			inv: localInv,
			localObjs: object.ObjMetadataSet{
